...
class OpenSeal:
    ...
    def show_about(self):
        ...
        tk.Label(about, text="Integrity Global", font=("Helvetica", 11, "bold"), fg="#ecf0f1", bg="#1a252f").pack()
        ...
        tk.Label(about, text="This software is free and open-source.\nCopyright © 2026 Integrity Global.", font=("Helvetica", 9), fg="#95a5a6", bg="#1a252f", justify=tk.CENTER).pack(pady=5)
